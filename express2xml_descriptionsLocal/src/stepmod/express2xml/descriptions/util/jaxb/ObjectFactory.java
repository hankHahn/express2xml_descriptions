 ...
 * generated in the stepmod.express2xml.descriptions.util.jaxb package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExtDescriptions_QNAME = new QName("thisSchema", "ext_descriptions");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: stepmod.express2xml.descriptions.util.jaxb
     * 
     */
    ...
    /**
     * Create an instance of {@link ExtDescriptionsType }
     * 
     */
    public ExtDescriptionsType createExtDescriptionsType() {
        return new ExtDescriptionsType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ExtDescriptionsType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "thisSchema", name = "ext_descriptions")
    public JAXBElement<ExtDescriptionsType> createExtDescriptions(ExtDescriptionsType value) {
        return new JAXBElement<ExtDescriptionsType>(_ExtDescriptions_QNAME, ExtDescriptionsType.class, null, value);
    }
